...
Run the experiment to generate few samples with the default \textbf{num\_steps}=1000. 
\textbf{Hint: }Once we stabilize the quality at 1000, we notice that the result is always almost the same.
...
Run the experiment to generate few samples with \textbf{num\_steps}=5, 10, 20, 50. 
